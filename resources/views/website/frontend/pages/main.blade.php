...
<html lang="en">
  ...
  @include('website.frontend.pages.head')
  ...
  <body class="goto-here">
	    		...
	    		<div class="col-lg-12 d-block">
		    		<div class="row d-flex">
		    			<div class="col-md pr-4 d-flex topper align-items-center">
						    ...
						    <span class="text">071-520107</span>
					    </div>
					    <div class="col-md pr-4 d-flex topper align-items-center">
					    	<div class="icon mr-2 d-flex justify-content-center align-items-center"><span class="icon-paper-plane"></span></div>
						    <span class="text">Agroapp@gmail.com</span>
					    </div>
					    <div class="col-md-5 pr-4 d-flex topper align-items-center text-lg-right">
						    <span class="text">Connecting Agri Needs || Experience The Real Agriculture</span>
					    </div>
				    </div>
			    </div>
		    </div>
    ...
    @include('website.frontend.pages.nav')
    <!-- END nav -->
    ...
    @include('website.frontend.pages.footer')
    
  

  <!-- loader -->
  @include('website.frontend.pages.foot')
